...
| `[1]` | Update spDeleteUpdate procedure | 不要な更新プログラムを削除するストアド プロシージャ `spDeleteUpdate` を、削除処理のパフォーマンスを改善した定義に更新します。 |
...
- [WSUS メンテナンス ガイド](https://jpmem.github.io/blog/wsus/2020-07-21_01/)
