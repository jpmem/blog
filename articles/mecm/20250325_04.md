...
※本記事では、WSUS、Intune、Windows Update、WU クライアント ポリシー に関する内容は対象外です。
...
適用させたい更新プログラムの Status が Missing になっているかを確認ください。該当の更新プログラムが見つからない場合、ソフトウェア更新ポイント上で該当の更新プログラムの承認状態が「未承認」でないか、そもそもソフトウェア更新ポイントと通信できていないか、もしくは、Windows 製品の更新プログラムが存在しない場合、WU クライアント ポリシーが有効になっているためにデュアル スキャン状態になっている可能性がございます。

デュアル スキャン状態については下記記事もご参考ください。

Configuration Manager 管理クライアントにおける Windows Update クライアント ポリシーの取り扱い(デュアル スキャン関連)  
https://jpmem.github.io/blog/mecm/20260403_01/
...
# 更新履歴
- 2026/4/6 デュアル スキャン記事の言及を追加、古い名称を修正, タグ追加
